...
def generate_description(image_url, max_length=100, max_image_size=(512, 512)):
    """
    Generates a description for an image using the Blip2 model.

    Args:
        image_url (str): The URL of the image.
        max_length (int): The maximum length of the generated description.
        max_image_size (tuple): The maximum allowed image size (width, height).

    Returns:
        str: The generated description (or None if an error occurs).
    """
